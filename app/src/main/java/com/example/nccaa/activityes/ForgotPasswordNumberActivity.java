...
public class ForgotPasswordNumberActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSendId.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(ForgotPasswordNumberActivity.this, ForgotPasswordNumberActivity2.class));
            }
        });
        txtRecId.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(ForgotPasswordNumberActivity.this, ForgotPasswordActivity.class));
            }
        });
